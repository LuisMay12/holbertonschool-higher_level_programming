#!/usr/bin/python3
"""Module that defines a Rectangle class with full
functionality and deletion message.

Includes size validation, area, perimeter,
visual and formal string representations,
and a deletion hook.
"""
...
class Rectangle:
    ...
    def __str__(self):
        """Returns a string that visually represents
        the rectangle with '#' characters.

        Returns:
            str: Rectangle as a string, or empty string
    ...
    def __repr__(self):
        ...
        can recreate the object with eval().
